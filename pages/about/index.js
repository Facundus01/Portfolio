...
export const aboutData = [
  ...
  },
  {
    ...
    info: [
      {
        title: 'TA (Teacher Assistan) - Honoree',
        stage: '2023',
      },
    ],
  },
  ...
  },
  {
    ...
    info: [
      ...
      {
        title: 'Soft Skilled - Henry',
        stage: '2023',
      },
      {
        title: 'Web Designer - freeCodeCamp',
        stage: '2023',
      },
    ],
  },
...
<div className="flex-1 flex-col justify-center">
  ...
  <div className="flex-1 flex flex-col justify-center">
    ...
    animate="show"
    exit="hidden" 
    className="max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0">Lorem impsum sdasdasdsadasdasdasdasdasdasdadasd</motion.p>
    ...
    className="hidden md:flex md:max-x-xl xl:max-w-none mx-auto xl:mx-0 mb-8">
     <div className="flex flex-1 xl:gap-x-6"> 
      ...
      after:h-full after:bg-white/10 
      after:absolute after:top-0 after:right-0">
      <div className="text-2xl cl:text-4xl font-extrabold text-accent mb-2">
      <CountUp start={0} end={0} duration={5}/> + 
        </div>
        <div className="text-xs uppercase tracking-[1px] 
        leading-[1.4] max-w-[100px]">Years of experience</div>
       </div>
      ...
      after:absolute after:top-0 after:right-0">
        ...
        <div className="text-xs uppercase tracking-[1px] 
        leading-[1.4] max-w-[100px]">Satisfied clients</div>
      </div>
      ...
      after:absolute after:top-0 after:right-0">
        ...
        <div className="text-xs uppercase tracking-[1px] 
        leading-[1.4] max-w-[100px]">Finished Projects</div>
      </div>
      ...
      <div className="relative flex-1">
        ...
        <div className="text-xs uppercase tracking-[1px] 
        leading-[1.4] max-w-[100px]">Winning awards</div>
      </div>
     </div>
    </motion.div>  
  </div>
  ...
  items-center xl:items-start">
    {aboutData[index].info.map((item, itemIndex)=>{
      ...
      max-w-max gap-x-2 items-center text-white/60">
        ...
        return <div className="text-2x1 text-white">{icon}</div>
        })}
        </div>
      </div>
    })}
